...
if ( __name__ == "__main__" ):
    ...
    artist = [ "The Charlie Daniels Band", "ABBA", "Jem","Stealers Wheel","Paul McCartney & Wings","ABBA", "Tom Jones", "Kim Mitchell", "Ted Nugent", "The 5th Dimension", "Big & Rich", "Don Felder" ]
    ...
    for cnt in range( 4,5 ):
        lyrics = LyricsFetcher().get_lyrics( 'Cascada', 'Because the night' )
